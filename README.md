...
| 문제 상황                                                                                                      |
| -------------------------------------------------------------------------------------------------------------- |
| <img src="https://github.com/wkd6262/Back2/assets/142865132/f5712fc7-8ebe-4973-b019-7f63c3d6b335" width="500"> |
| 데이터 출력은 되었으니 .map으로 출력을 하려고 해도 어느 문제인지 자꾸 출력이 안 되는 점 발생 -> 출력 되는 div,li에 key 값을 적지 않아서 출력이 안되었음. (이런 단순한 실수는 줄이기)                   |
